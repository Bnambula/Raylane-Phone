    ...
    <div style={{ paddingTop:'var(--nav-h)', background:'var(--gray-light)', minHeight:'100vh' }}>
      ...
      <div style={{ background:'linear-gradient(135deg,var(--blue),#1a52b3)', padding:'32px 0 28px' }}>
        <div className="container">
          <button onClick={() => navigate('/')} style={{ background:'none', border:'none', color:'rgba(255,255,255,0.65)', cursor:'pointer', fontSize:13, fontFamily:"'Poppins',sans-serif", marginBottom:10, display:'flex', alignItems:'center', gap:6 }}>
            <- Back
          </button>
