...
const SERVICES = [
  { icon:'🧍', title:'Passenger Booking', desc:'Search routes, pick seats live, pay via mobile money, get your QR ticket instantly.', to:'/book', color:'#0B3D91', label:'Book Now' },
  { icon:'📦', title:'Parcel Delivery', desc:'Send envelopes to heavy cargo across Uganda. GPS-tracked, insured, and same-day dispatch.', to:'/parcels', color:'#15803d', label:'Send Parcel' },
  { icon:'🚌', title:'Charter Vehicles', desc:'Need a private bus for events, schools, or corporate travel? Get a full vehicle quote.', to:'/book?charter=true', color:'#7c3aed', label:'Get Quote' },
  ...
  { icon:'📊', title:'Operator Services', desc:'Join Raylane as a transport operator. Digitise your fleet and reach thousands of passengers.', to:'/partner', color:'#1a52b3', label:'Join Now' },
]
