...
const F=[
  {icon:'⚡',t:'Real-Time Booking',d:'Seat availability updates live. No lag, no overbooking, ever.',c:'#dbeafe'},
  {icon:'🔒',t:'No Double Booking',d:'Our Seat Sync Engine locks your seat the instant payment confirms.',c:'#dcfce7'},
  {icon:'📱',t:'Mobile Money Pay',d:'MTN MoMo & Airtel Money. No bank card needed. Done in seconds.',c:'#fef9c3'},
  {icon:'🌍',t:'East Africa Coverage',d:'Kampala to Nairobi, Gulu to Kigali — 1,000+ routes covered.',c:'#fce7f3'},
  {icon:'⭐',t:'Vetted Operators',d:'Every operator is verified and approved by Raylane admin.',c:'#ede9fe'},
  {icon:'🎫',t:'Instant QR Ticket',d:'Digital ticket via SMS and app. No printing. No queues.',c:'#ffedd5'},
]
