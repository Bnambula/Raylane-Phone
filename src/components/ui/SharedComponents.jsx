...
export function EmptyState({ icon='?', title, desc, action, onAction }) {
  return (
    <div style={{ textAlign:'center', padding:'40px 20px' }}>
      <div style={{ width:64, height:64, borderRadius:20, background:'#F5F7FA', display:'flex', alignItems:'center', justifyContent:'center', margin:'0 auto 16px', fontSize:28, color:'#94a3b8' }}>{typeof icon==='string' ? icon.replace(/[\[\]]/g,'') : icon}</div>
