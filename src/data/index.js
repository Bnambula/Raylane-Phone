...
export const parcels = [
  { id:'envelope', icon:'📄', name:'Envelope',      price:5000,  maxWeight:'0.5 kg', desc:'Letters, IDs, certificates' },
  { id:'small',    icon:'📦', name:'Small Parcel',  price:12000, maxWeight:'2 kg',   desc:'Clothes, books, electronics' },
  { id:'large',    icon:'🎁', name:'Large Parcel',  price:20000, maxWeight:'10 kg',  desc:'Household items, appliances' },
  { id:'cargo',    icon:'🏗️', name:'Heavy Cargo',   price:30000, maxWeight:'50 kg+', desc:'Commercial freight, machinery' },
]
