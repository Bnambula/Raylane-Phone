/**
 * RAYLANE EXPRESS -- Demo / seed data
 * In production, every function here becomes a Supabase db.* call
 */
...
export const operators = [
  ...
  { id:'op-004', company_name:'Fast Coaches Ltd',  shortName:'FC',  contact:'Grace Auma',     phone:'0752-678-901', email:'grace@fastcoaches.ug',       fleet_size:4, status:'ACTIVE', is_premium:false, operator_type:'EXTERNAL', managed_by_raylane:false, merchant_code:'FAST_COACHES',commission_rate:0.08, rating:4.3, reviews:87,  boarding_lat:0.3492, boarding_lng:32.5801, boarding_label:'Nakivubo Bus Terminal, Bay 5', color:'#7c3aed' },
...
export const testimonials = [
  ...
  { id:2, name:'James Okello',    role:'Business Traveller', city:'Gulu', avatar:'JO', rating:5, text:'I travel Kampala-Gulu every two weeks. Since joining Raylane, I book in advance, choose my window seat, and the bus is always on time. The driver tracking is the best feature -- I know exactly when to head to the stage.' },
  { id:3, name:'Grace Auma',      role:'Operator (Fast Coaches)', city:'Kampala', avatar:'GA', rating:5, text:'As an operator, Raylane filled my buses. Before, I was lucky to get 40% capacity. Now I regularly run at 85-90%. The dashboard shows me everything: bookings, revenue, and which routes are most profitable.' },
  { id:4, name:'David Kamya',     role:'Tourist', city:'London', avatar:'DK', rating:5, text:'Visiting Uganda from the UK -- I was worried about getting around. Raylane made it simple. English interface, MasterCard payment coming soon, and the parcel service even shipped my luggage ahead to Kabale. World class service.' },
  { id:5, name:'Fatuma Hassan',   role:'Parent', city:'Jinja', avatar:'FH', rating:5, text:'I send parcels to my children in Kampala every week. The insurance option gave me peace of mind -- my phone arrived safely and the recipient got an SMS when it was on the bus. Zero stress.' },
]
...
export const travelTips = [
  ...
  { id:3, title:'The Kampala-Kabale road is breathtaking', excerpt:'The Western Circuit through Mbarara to Kabale offers Uganda's most scenic road journey. Request a window seat in advance. Bring a camera.', category:'Routes', readTime:'3 min', image:'https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?w=400&q=80' },
]

export const parcels = [
  { id:'envelope', icon:'Doc', name:'Envelope',      price:5000,  maxWeight:'0.5 kg', desc:'Letters, IDs, certificates' },
  { id:'small',    icon:'Box', name:'Small Parcel',  price:12000, maxWeight:'2 kg',   desc:'Clothes, books, electronics' },
  { id:'large',    icon:'Pkg', name:'Large Parcel',  price:20000, maxWeight:'10 kg',  desc:'Household items, appliances' },
  { id:'cargo',    icon:'Cgo', name:'Heavy Cargo',   price:30000, maxWeight:'50 kg+', desc:'Commercial freight, machinery' },
]
