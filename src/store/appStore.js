...
export const INITIAL_STATE = {
  ...
  notifications: {
    admin: [
      ...
      { id:'N-003', type:'LOAN_OVERDUE',  icon:'[RED]', msg:'YY Coaches bank loan overdue 3 months',      time:'1 day ago', read:true,  link:'bankloans' },
    ],
    operator: {
      'op-001': [
        { id:'N-101', type:'BOOKING',   icon:'[TKT]', msg:'New booking - Seat 47 (UGX 25,000) MTN MoMo', time:'2 min ago', read:false },
      ...
      'op-rlx': [
        { id:'N-301', type:'BOOKING',   icon:'[TKT]', msg:'New advance booking - Seat 3 (Raylane Fleet)', time:'1 hr ago', read:false },
      ],
    }
  },
