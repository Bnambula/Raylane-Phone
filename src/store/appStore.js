...
export const INITIAL_STATE = {
  ...
  /* ─── TRIPS ─── */
  trips: [
    { id:'T-001', operator_id:'op-001', operator_name:'Global Coaches Ltd', plate:'UBF 234K', from:'Kampala', to:'Mbale', date:'2026-05-12', departs:'10:00 AM', seat_type:'55', price:25000, seats_total:55, seats_booked:36, status:'APPROVED', created_at:'2026-05-10', boarding_pin:{ lat:0.3476, lng:32.5825, label:'Kampala Coach Park, Gate 3' }, notes:'AC available', amenities:['ac','usb'] },
    { id:'T-002', operator_id:'op-001', operator_name:'Global Coaches Ltd', plate:'UBF 234K', from:'Mbale', to:'Kampala', date:'2026-05-12', departs:'4:00 PM', seat_type:'55', price:25000, seats_total:55, seats_booked:12, status:'APPROVED', created_at:'2026-05-10', boarding_pin:{ lat:1.0754, lng:34.1736, label:'Mbale Bus Terminal' }, notes:'', amenities:['ac'] },
    { id:'T-003', operator_id:'op-002', operator_name:'YY Coaches', plate:'UAR 512B', from:'Kampala', to:'Gulu', date:'2026-05-13', departs:'7:00 AM', seat_type:'67', price:35000, seats_total:67, seats_booked:0, status:'PENDING_APPROVAL', created_at:'2026-05-11', boarding_pin:{ lat:0.3489, lng:32.5814, label:'New Taxi Park, Stand 7' }, notes:'Direct route', amenities:[] },
    { id:'T-004', operator_id:'op-003', operator_name:'Link Bus', plate:'UAK 890C', from:'Kampala', to:'Nairobi', date:'2026-05-14', departs:'6:00 AM', seat_type:'65', price:60000, seats_total:65, seats_booked:18, status:'APPROVED', created_at:'2026-05-11', boarding_pin:{ lat:0.3501, lng:32.5798, label:'Namirembe Road Bus Park' }, notes:'Passport required', amenities:['ac','wifi'] },
    { id:'T-005', operator_id:'op-rlx', operator_name:'Raylane Express Fleet', plate:'UBF 001K', from:'Kampala', to:'Mbale', date:'2026-05-12', departs:'8:00 AM', seat_type:'55', price:28000, seats_total:55, seats_booked:22, status:'APPROVED', created_at:'2026-05-10', boarding_pin:{ lat:0.3476, lng:32.5825, label:'Raylane HQ, Kampala' }, notes:'Premium Raylane service', amenities:['ac','wifi','usb'], operator_type:'INTERNAL' },
  ],
  ...
  notifications: {
    ...
    operator: {
      ...
      'op-rlx': [
        { id:'N-301', type:'BOOKING',   icon:'🎫', msg:'New advance booking – Seat 3 (Raylane Fleet)', time:'1 hr ago', read:false },
      ],
    }
  },
